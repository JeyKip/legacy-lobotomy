...
from assignments.apiviews import AssingmentViewSet, CategoryViewSet, UserDiscoverViewSet, UserPlaybookViewSet
from other.views import TermsAndConditionsViewSet
from users.views import TeamDashboardViewSet, UserDetailsView
